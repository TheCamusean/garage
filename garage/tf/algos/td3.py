...
class TD3(OffPolicyRLAlgorithm):
    ...
    (TD3) algorithm based on https://arxiv.org/pdf/1802.09477.pdf.
    ...
    def init_opt(self):
        with tf.name_scope(self.name, "TD3"):
            ...
            self.target_qf2_f_prob_online, _, _, _ = self.qf2._build_net(
            ...
            with tf.name_scope("setup_target"):
                ...
                target_init_op = policy_init_ops + min(qf_init_ops,
                                                       qf2_init_ops)
                target_update_op = policy_update_ops + min(
                    qf_update_ops, qf2_update_ops)
